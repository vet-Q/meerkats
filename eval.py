...
if __name__ == '__main__':    
    ...
    parser.add_argument('--test_data', default='data/val/val.csv',type=str, help='path to the test data')    
    parser.add_argument('--batch_size', default=1, type=int)
    parser.add_argument('--weight', default='runs/best.pt', type=str, help='path to the weight file')
